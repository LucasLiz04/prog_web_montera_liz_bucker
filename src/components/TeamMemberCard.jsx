...
const TeamMemberCard = ({ photoUrl, name, course, role, socialLinks }) => {
    ...
    return (
        <div className="bg-slate-800 rounded-xl shadow-lg border border-slate-700 p-6 flex flex-col items-center text-center transform hover:scale-105 hover:shadow-[#0653AF] transition-all duration-300 ease-in-out min-h-[360px]">
            <img
